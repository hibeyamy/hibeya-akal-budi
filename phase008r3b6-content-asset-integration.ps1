...
$work = Join-Path $logs ("phase008r3b6-" + $stamp)
$log = Join-Path $work "phase008r3b6.log"
$zip = Join-Path $logs ("phase008r3b6-content-asset-integration-" + $stamp + ".zip")
...
trap {
  Write-Log ""
  Write-Log "PHASE 008R3B.6: FAILED"
...
Write-Host "HIBEYA AKAL BUDI - PHASE 008R3B.6" -ForegroundColor Cyan
Write-Host "Production Content + Asset Integration QA" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan

$sourceAudit = Join-Path $root "phase008r3b6-content-asset-audit.mjs"
$targetAudit = Join-Path $root "tools\assets\audit-content-runtime-integration.mjs"
Copy-Item $sourceAudit $targetAudit -Force
Write-Log "PASS: R3B.6 integration audit installed"

Invoke-Step "Content + asset runtime integration audit" "node tools/assets/audit-content-runtime-integration.mjs"
...
Write-Log ""
Write-Log "PHASE 008R3B.6: PASS"
Write-Log "Semantic content-to-asset integration is governed end-to-end."
Write-Log "Six approved fruit/hibiscus assets resolve to production WebP derivatives."
Write-Log "Learner/content runtime contains no governed physical-file path leaks."
Write-Log "Correctness remains mechanic-owned and getAsset remains the visual resolver boundary."
Write-Log "Content and asset generated outputs remain reproducible."
Write-Log "No approved artwork, curriculum, answer key, mastery or progression rule was changed."

Save-Zip
Write-Host "PHASE 008R3B.6: PASS" -ForegroundColor Green
