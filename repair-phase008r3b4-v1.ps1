...
$work=Join-Path $logs ("phase008r3b4-repair-v1-"+$stamp)
$log=Join-Path $work "repair.log"
$zip=Join-Path $logs ("phase008r3b4-repair-v1-"+$stamp+".zip")
...
trap{Log "";Log "PHASE 008R3B.4 REPAIR V1: FAILED";Log ($_|Out-String);Log $_.ScriptStackTrace;ZipLog;Write-Host ("ZIP: "+$zip) -ForegroundColor Yellow;exit 1}

Write-Host "====================================================" -ForegroundColor Cyan
Write-Host "HIBEYA AKAL BUDI - PHASE 008R3B.4 REPAIR V1" -ForegroundColor Cyan
Write-Host "Restore Learner Styling in Journey Story" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan

Run "Install learner stylesheet at integration-story boundary" "node repair-phase008r3b4-v1-patch.mjs"
...
Log ""
Log "PHASE 008R3B.4 REPAIR V1: PASS"
Log "Learner/Journey Storybook integration now loads the learner stylesheet."
Log "Responsive QA runs against styled production learner components."
Log "Mobile, tablet and desktop production-state regression passed."
Log "No learner production logic, curriculum, asset or dependency was changed."
ZipLog
Write-Host "PHASE 008R3B.4 REPAIR V1: PASS" -ForegroundColor Green
